...
async function randomPublic(driver) {
    try {
        ...
        const inputList = driver.findElement(By.id('spokenLanguagesJS'));
        const buttons = inputList.findElements(By.className('languageContainer__input'));
